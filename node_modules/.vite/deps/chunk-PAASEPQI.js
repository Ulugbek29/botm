import {
  ButtonBase_default,
  Transition_default
} from "./chunk-5VHSYSSD.js";
import {
  getOverlayAlpha_default,
  getUnit,
  toUnitless,
  useTheme
} from "./chunk-JNVYM2VM.js";
import {
  Popper_default,
  appendOwnerState,
  capitalize_default,
  ...
  useSlotProps
} from "./chunk-BB6Q2GEU.js";
import {
  TextareaAutosize_default
} from "./chunk-4IQQQ36M.js";
import {
...
} from "./chunk-GMGEVGJT.js";
import {
  clsx_m_default,
  init_clsx_m
} from "./chunk-ITGVT6QF.js";
import {
  HTMLElementType,
  chainPropTypes,
  composeClasses,
...
var Alert = React9.forwardRef(function Alert2(inProps, ref) {
  ...
  return (0, import_jsx_runtime10.jsxs)(AlertRoot, _extends({
    ...
    children: [icon !== false ? (0, import_jsx_runtime9.jsx)(AlertIcon, {
      ...
      ownerState,
      className: classes.action,
      children: (0, import_jsx_runtime9.jsx)(AlertCloseButton, _extends({
        size: "small",
        ...
        children: (0, import_jsx_runtime9.jsx)(AlertCloseIcon, _extends({
          fontSize: "small"
        }, closeIconProps))
      }))
    }) : null]
...
var Typography = React10.forwardRef(function Typography2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(TypographyRoot, _extends({
    as: Component,
    ref,
    ownerState,
    className: clsx_m_default(classes.root, className)
...
var AlertTitle = React11.forwardRef(function AlertTitle2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(AlertTitleRoot, _extends({
    gutterBottom: true,
    component: "div",
    ownerState,
    ref,
...
var Rating = React35.forwardRef(function Rating2(inProps, ref) {
  const props = useThemeProps({
    name: "MuiRating",
    props: inProps
  });
  ...
  const [emptyValueFocused, setEmptyValueFocused] = React35.useState(false);
  const ownerState = _extends({}, props, {
    defaultValue,
    disabled,
    emptyIcon,
...
var SpeedDial = React38.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded23), other = _objectWithoutPropertiesLoose(props, _excluded24);
  ...
  const eventTimer = React38.useRef();
  React38.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime43.jsxs)(SpeedDialRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ref,
    role: "presentation",
    onKeyDown: handleKeyDown,
    ...
    children: [(0, import_jsx_runtime42.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime42.jsx)(SpeedDialFab, _extends({
        color: "primary",
...
var Tooltip = React39.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const [childNode, setChildNode] = React39.useState();
  const [arrowRef, setArrowRef] = React39.useState(null);
  const ignoreNonTouchEvents = React39.useRef(false);
  const disableInteractive = disableInteractiveProp || followCursor;
  const closeTimer = React39.useRef();
  const enterTimer = React39.useRef();
  const leaveTimer = React39.useRef();
  const touchTimer = React39.useRef();
  ...
  const prevUserSelect = React39.useRef();
  const stopTouchInteraction = React39.useCallback(() => {
  ...
  const [, setChildIsFocusVisible] = React39.useState(false);
  const handleBlur = (event) => {
    handleBlurVisible(event);
    if (isFocusVisibleRef.current === false) {
  ...
  const popperRef = React39.useRef();
  const handleMouseMove = (event) => {
    const childrenProps2 = children.props;
  ...
  const popperOptions = React39.useMemo(() => {
  ...
  return (0, import_jsx_runtime45.jsxs)(React39.Fragment, {
    children: [React39.cloneElement(children, childrenProps), (0, import_jsx_runtime44.jsx)(PopperComponent, _extends({
      ...
      }) => (0, import_jsx_runtime44.jsx)(TransitionComponent, _extends({
        timeout: theme.transitions.duration.shorter
      }, TransitionPropsInner, transitionProps, {
        children: (0, import_jsx_runtime45.jsxs)(TooltipComponent, _extends({}, tooltipProps, {
          children: [title, arrow ? (0, import_jsx_runtime44.jsx)(ArrowComponent, _extends({}, tooltipArrowProps, {
            ref: setArrowRef
          })) : null]
        }))
      }))
...
var _excluded26 = ["className", "delay", "FabProps", "icon", "id", "open", "TooltipClasses", "tooltipOpen", "tooltipPlacement", "tooltipTitle"];
...
var SpeedDialAction = React40.forwardRef(function SpeedDialAction2(inProps, ref) {
  ...
  const fab = (0, import_jsx_runtime46.jsx)(SpeedDialActionFab, _extends({
    size: "small",
  ...
  if (tooltipOpenProp) {
    return (0, import_jsx_runtime47.jsxs)(SpeedDialActionStaticTooltip, _extends({
      id,
      ref,
      className: classes.staticTooltip,
      ownerState
    }, other, {
      children: [(0, import_jsx_runtime46.jsx)(SpeedDialActionStaticTooltipLabel, {
  ...
  return (0, import_jsx_runtime46.jsx)(Tooltip_default, _extends({
    id,
    ref,
    title: tooltipTitle,
...
var _excluded27 = ["className", "icon", "open", "openIcon"];
...
var SpeedDialIcon = React42.forwardRef(function SpeedDialIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsxs)(SpeedDialIconRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ref,
    ownerState
  }, other, {
...
var TabScrollButton = React45.forwardRef(function TabScrollButton2(inProps, ref) {
...
var Tabs = React47.forwardRef(function Tabs2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime55.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_m_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayScroll.start || displayScroll.end;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime55.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime55.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime55.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
  ...
  return (0, import_jsx_runtime56.jsxs)(TabsRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref,
    as: component
    ...
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime56.jsxs)(TabsScroller, {
      ...
      children: [(0, import_jsx_runtime55.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
var _excluded31 = ["children", "className", "color", "disabled", "disableFocusRipple", "fullWidth", "onChange", "onClick", "selected", "size", "value"];
...
var ToggleButton = React48.forwardRef(function ToggleButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime57.jsx)(ToggleButtonRoot, _extends({
    className: clsx_m_default(classes.root, className),
    disabled,
    focusRipple: !disableFocusRipple,
    ref,
...
var _excluded33 = ["children", "className", "color", "disabled", "exclusive", "fullWidth", "onChange", "orientation", "size", "value"];
...
var ToggleButtonGroup = React49.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime58.jsx)(ToggleButtonGroupRoot, _extends({
    role: "group",
    className: clsx_m_default(classes.root, className),
    ref,
    ownerState
...
//# sourceMappingURL=chunk-PAASEPQI.js.map
